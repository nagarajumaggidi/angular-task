...
import { fullobject10} from '../invoice';
import { IndexService } from 'src/app/index/services/index.service';
@Component({
  selector: 'app-adddocissue',
  templateUrl: './adddocissue.component.html',
  styleUrls: ['./adddocissue.component.scss']
})
export class AdddocissueComponent implements OnInit  {
  getinvoice: any;
