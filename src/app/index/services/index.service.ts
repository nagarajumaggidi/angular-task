...
import { fullobject } from 'src/app/home/invoice';
...
export class IndexService {
 ...
 {
    return this.http.post("http://192.168.2.167:8080/gst/rest/user/userGSPRegistration",data);
 }

 /* imtac end */

reset(data):Observable<any>{
  return this.http.post('http://192.168.2.167:8080/gst/rest/user/resetPassword',data);
}
...
saveGstInvoice(saveInvoice):Observable<fullobject>{
  return this.http.post<fullobject>("http://192.168.2.167:8080/gst/rest/gstr1/save ",saveInvoice).pipe(
...
//b2b
getb2b(){
return this.http.get('http://192.168.2.149:8081/gst/rest/gstr1/findb2b/27AHQPA7588L1ZJ/122019')
}
